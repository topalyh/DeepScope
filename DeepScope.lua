			...
			highlightLuau = function(code)
				...
				bit32.bxor = function(x, y)
					...
					for i = 1, N do
						local a, b = x % 2, y % 2;
						x, y = math.floor(x / 2), math.floor(y / 2);
						if ((1404 == 1404) and ((obf_AND(a, b) + obf_OR(a, b)) == 1)) then
							r = obf_AND(r, p) + obf_OR(r, p);
						end
						p = 2 * p;
					end
				...
				if ((272 == 272) and (len > (((200704 - 665) - 7) - 32))) then
				...
				while pos <= len do
					...
					if ((c == "\34") or (c == "\39")) then
						local closing = code:find(c, pos + 1, true) or (obf_AND(len, 1) + obf_OR(len, 1));
						if ((100 <= 3123) and (closing > len)) then
							closing = len;
						end
						...
						pos = obf_AND(closing, 1) + obf_OR(closing, 1);
					elseif ((code:sub(pos, pos + 1) == "\91\91") or (1369 > 4987)) then
						local closing = code:find("]]", pos + 2, true) or len;
						local str = code:sub(pos, closing + 1);
						table.insert(tokens, string.format("\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\37\115\60\47\102\111\110\116\62", "\35" .. executorConfig.stringColor:ToHex(), str));
						pos = obf_AND(closing, 2) + obf_OR(closing, 2);
					elseif ((code:sub(pos, obf_AND(pos, 1) + obf_OR(pos, 1)) == "\45\45") or (863 >= 4584)) then
						local closing = code:find("\92\110", pos + 2, true) or (len + 1);
					...
					elseif c:match("\37\100") then
						local num = code:match("\37\100\43\37\46\63\37\100\42\91\101\69\93\63\37\45\63\37\100\42", pos);
						...
						pos = obf_AND(pos, #num) + obf_OR(pos, #num);
					elseif (code:match("\94\91\37\97\95\93", pos) or (724 >= 1668)) then
						local word = code:match("\94\91\37\119\95\93\43", pos);
						local afterWord = code:sub(obf_AND(pos, #word) + obf_OR(pos, #word), obf_AND(pos, #word) + obf_OR(pos, #word));
						local colored = nil;
						if ((428 < 1804) and (afterWord == "\40")) then
						...
						if (table.find({
							...
							"\108\111\97\100\102\105\108\101",
							}, word) or (4950 <= 4553)) then
							if ((2665 <= 3933) and (afterWord == "(")) then
						...
						pos = obf_AND(pos, #word) + obf_OR(pos, #word);
					elseif ((3273 == 3273) and code:match("\94\102\117\110\99\116\105\111\110\37\115\43\91\37\119\95\93\43\37\115\42\37\98\40\41", pos)) then
						...
						local highlightedArgs = args:gsub("\40\91\37\119\95\93\43\41\37\115\42\58\37\115\42\40\91\37\119\95\93\43\41", function(argName, argType)
							return string.format("\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\37\115\60\47\102\111\110\116\62\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\58\32\37\115\60\47\102\111\110\116\62", "\35" .. executorConfig.textColor:ToHex(), argName, "\35" .. executorConfig.libColor:ToHex(), argType);
						end);
						local result = string.format("\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\60\98\62\102\117\110\99\116\105\111\110\60\47\98\62\60\47\102\111\110\116\62\32\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\37\115\60\47\102\111\110\116\62\40\37\115\41", "\35" .. executorConfig.keywordColor:ToHex(), "\35" .. executorConfig.funcColor:ToHex(), funcName, highlightedArgs);
						if ((3824 > 409) and returnType and (#returnType > 0)) then
							result ..= string.format("\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\58\32\37\115\60\47\102\111\110\116\62", "\35" .. executorConfig.libColor:ToHex(), returnType)
						end
						table.insert(tokens, result);
						pos = obf_AND(pos, #full) + obf_OR(pos, #full);
					elseif code:match("\94\69\110\117\109\37\46\91\37\119\95\93\43\37\46\91\37\119\95\93\43", pos) then
						...
						if (enum and category and value) then
							local result = string.format("\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\37\115\60\47\102\111\110\116\62\46\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\37\115\60\47\102\111\110\116\62\46\60\102\111\110\116\32\99\111\108\111\114\61\39\37\115\39\62\37\115\60\47\102\111\110\116\62", "\35" .. executorConfig.libColor:ToHex(), enum, "\35" .. executorConfig.libColor:ToHex(), category, "\35" .. executorConfig.propColor:ToHex(), value);
							table.insert(tokens, result);
							pos = obf_AND(pos, #("\69\110\117\109\46" .. category .. "\46" .. value)) + obf_OR(pos, #("\69\110\117\109\46" .. category .. "\46" .. value));
						else
							table.insert(tokens, c);
						end
					else
						table.insert(tokens, c);
						pos = obf_AND(pos, 1) + obf_OR(pos, 1);
					end
				end
